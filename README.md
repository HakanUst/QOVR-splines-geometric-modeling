...
- **Sheet 2: rip=0.7, sip=0.5, uip=0.5, tip=0.3.
- **Sheet 3: rip=0.6, sip=0.5, uip=0.7, tip=0.3.
- **Sheet 4: rip=0.3, sip=0.5, uip=0.5, tip=0.7.
- **Sheet 5: rip=0.4, sip=0.6, uip=0.7, tip=0.4.
- **Sheet 6: rip=0.3, sip=0.4, uip=0.3, tip=0.5.

## Terms of Use

This data is provided solely for peer-review evaluation and scientific transparency purposes associated with the publication process. 
